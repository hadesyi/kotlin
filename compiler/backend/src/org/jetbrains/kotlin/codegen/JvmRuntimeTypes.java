...
import org.jetbrains.kotlin.coroutines.CoroutineConstantsKt;
    ...
    private static KotlinType createNullableAnyContinuation(@NotNull ModuleDescriptor module) {
        ClassDescriptor classDescriptor =
                DescriptorUtilsKt.resolveTopLevelClass(
                        module, CoroutineConstantsKt.CONTINUATION_INTERFACE_FQ_NAME, NoLookupLocation.FROM_BACKEND);

        assert classDescriptor != null : CoroutineConstantsKt.CONTINUATION_INTERFACE_FQ_NAME + " was not found in built-ins";
