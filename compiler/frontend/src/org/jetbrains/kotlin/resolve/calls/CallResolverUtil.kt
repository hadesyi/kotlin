...
fun getEffectiveExpectedType(parameterDescriptor: ValueParameterDescriptor, argument: ValueArgument): KotlinType {
    ...
    if (parameterDescriptor.isCoroutine && argument.getArgumentExpression() is KtLambdaExpression) {
        val receiverType = parameterDescriptor.type.arguments[0].type
        ...
        return parameterDescriptor.type.replace(
                ...
                CompositeTypeCapabilities(
                        parameterDescriptor.type.capabilities,
                        SingletonTypeCapabilities(
                                CoroutineFunctionTypeTagTypeCapability::class.java, CoroutineFunctionTypeTagTypeCapability)))
    }
